    ...
    <nav class="flex items-center justify-between flex-wrap bg-[#E8CDF9] p-6 shadow-md sticky top-0">
        ...
        <div class="relative ml-3">
          <div>
            ...
            <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" type="button" class="flex px-2 py-1 rounded-full focus:ring-1 focus:ring-white hover:bg-white"  aria-expanded="false" aria-haspopup="true">
            ...
            <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-30">
                    ...
                    <li>
                        <Link href="#" class="block px-4 py-2 hover:bg-gray-100 ">Settings</Link>
                    </li>
                    <li>
                        <Link href="#" class="block px-4 py-2 hover:bg-gray-100 ">Sign out</Link>
                    </li>
                    </ul>
                </div>
          </div>
